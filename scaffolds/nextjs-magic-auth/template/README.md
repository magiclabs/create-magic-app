This scaffold is meant to help you bootstrap your own projects with [Magic Auth](https://magic.link/docs/auth/overview). Magic is a developer SDK that integrates with your application to enable passwordless Web3 onboarding.
